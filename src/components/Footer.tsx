...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#1E1C59] text-white pb-24 lg:pb-0">
      {/* Gold meander line */}
      <div className="h-1 bg-gradient-to-r from-transparent via-[#F3BA2F] to-transparent opacity-60" />
            ...
            <div className="flex flex-wrap justify-center lg:justify-start items-center gap-2 text-sm mb-6">
              {BUSINESS.services.map((service, i) => (
                <span key={service} className="flex items-center gap-2">
                  <span className="text-[#F3BA2F] font-semibold">{service}</span>
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="flex flex-col items-center lg:items-start gap-3 text-sm">
              ...
              <a
                ...
                className="text-white hover:text-[#F3BA2F] font-semibold transition-colors inline-flex items-center gap-2"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-white/70 hover:text-[#F3BA2F] transition-colors inline-flex items-center gap-2"
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
