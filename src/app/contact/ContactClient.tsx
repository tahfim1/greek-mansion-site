  ...
  return (
    <>
      ...
      <section className="relative pt-28 lg:pt-32 pb-16 bg-[#1E1C59] overflow-hidden">
        ...
        >
          <motion.p variants={heroFadeInUp} className="text-[#F3BA2F] text-sm font-semibold tracking-[0.15em] uppercase mb-3">Get In Touch</motion.p>
              ...
              <div className="space-y-6">
                ...
                <motion.div variants={slideInRightSlow} className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-full bg-[#1E1C59]/5 flex items-center justify-center flex-shrink-0">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#F3BA2F" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="text-[#F3BA2F] font-semibold text-sm hover:text-[#C68B15] transition-colors inline-flex items-center gap-1 mt-2"
                    >
                      Get Directions →
                    </a>
                  </div>
                ...
                <motion.div variants={slideInRightSlow} className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href={BUSINESS.phoneTel} className="text-[#F3BA2F] font-bold text-xl hover:text-[#C68B15] transition-colors">
                      {BUSINESS.phone}
                    </a>
                  </div>
                </motion.div>
                    ...
                    <div className="flex items-center gap-2 text-sm text-[#11102F]/60">
                      {BUSINESS.services.map((service, i) => (
                        <span key={service} className="flex items-center gap-2">
                          <span>{service}</span>
                          {i < BUSINESS.services.length - 1 && <span className="text-[#F3BA2F]">•</span>}
                        </span>
                      ))}
                    </div>
                  </div>
      ...
      <section className="section-padding bg-white overflow-hidden">
        <motion.div 
          ...
          variants={staggerContainerSlow}
        >
          <motion.p variants={fadeInUpSlow} className="text-[#F3BA2F] text-sm font-semibold tracking-[0.15em] uppercase mb-3">Planning an Event?</motion.p>
