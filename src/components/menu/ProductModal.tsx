            ...
            <div className="w-full lg:w-1/2 p-5 sm:p-8 lg:p-12 overflow-y-auto flex flex-col">
              <div className="mb-4 sm:mb-8">
                ...
                {product.variants && product.variants.length === 0 && (
                  <p className="text-2xl sm:text-3xl text-[#F3BA2F] font-bold" style={{ fontFamily: "'Marcellus', serif" }}>
                      ...
                      <button
                        ...
                        className={`p-4 rounded-xl border-2 text-left transition-all flex flex-col items-start ${
                          selectedVariant?.label === v.label 
                            ? 'border-[#F3BA2F] bg-white shadow-md text-[#1E1C59]' 
                            : 'border-[#E8DCCB] bg-white/50 text-[#11102F]/70 hover:border-[#F3BA2F]/50 hover:bg-white'
                        }`}
                      >
                        <span className="font-bold text-lg mb-1" style={{ fontFamily: "'Marcellus', serif" }}>{v.label}</span>
                        <span className="text-[#F3BA2F] font-bold">{formatPrice(v.price)}</span>
                      </button>
                    ))}
                  </div>
                </div>
